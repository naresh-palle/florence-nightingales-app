...
const s = StyleSheet.create({
  ...
  card: { backgroundColor: 'rgba(255, 255, 255, 0.85)', borderRadius: 20, padding: 24, shadowColor: '#000', shadowOpacity: 0.3, shadowRadius: 20, elevation: 10 },
  ...
  input: { borderWidth: 1.5, borderColor: '#e2e8f0', borderRadius: 12, padding: 14, fontSize: 15, color: '#2d3748', backgroundColor: 'rgba(255, 255, 255, 0.9)', marginBottom: 16 },
  passwordRow: { flexDirection: 'row', alignItems: 'center', borderWidth: 1.5, borderColor: '#e2e8f0', borderRadius: 12, backgroundColor: 'rgba(255, 255, 255, 0.9)', marginBottom: 10 },
